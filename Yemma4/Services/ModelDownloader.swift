...
private final class ModelDownloadCoordinator: NSObject, URLSessionDownloadDelegate, URLSessionTaskDelegate {
    struct Result {
        let tempFileURL: URL
    }
    ...
    init(downloadURL: URL, resumeData: Data?, progressHandler: @escaping (Double) -> Void = { _ in }) {
